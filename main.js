document.addEventListener('DOMContentLoaded', () => {
    ...
    //Expected output: Array ["each div content", "each div content"... ]
...
function moveLeft() {
  ...
  function checkRotatedPosition(position){
    ...
    function rotate() {
      undraw();
      currentRotation ++;
      if(currentRotation === current.length) { //if current rotation = 4, put it back to 0
        currentRotation = 0;
      }
      current = theTetrominoes[random][currentRotation];
    ...
    function displayShape() {
      //remove any trace of a tetromino form the grid
